...
for (var index = 0; index < json.length; ++index){
	if(index % 8 == 0){
		...
		html += '<tr style="height: 33px;"><td valign="top" class="tooltip"><span class="tooltiptext">' + json[index].description + '</span><a href="{{url_home}}/learning_guide/pages/{{location(' + index + ')}}/{{location(' + index + ')}}.html" target="_blank"><img src="https://raw.githubusercontent.com/poc-org/hrit/test/learning_guide/res/images/{{location(' + index + ')}}.jpg" class="imgBox" /></a></td></tr>';
	}
}
html += '</tbody></table>';
